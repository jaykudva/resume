...
\begin{document}
	...
	\begin{itemize}
	\item Implemented large scale website development projects in ReactJS
	\item Created data aggregation tool in Python with Pandas that tracks influencer audience retention statistics
	\item Developed in-house \& Growth tools with a backend in Firebase
	\item Gained experience in iOS development through building workflows in Swift
	\end{itemize}
